...
P_a(k,s)
W_exp(k)
*Define sets to import table data
Sets
...
*Capacity variables
Positive variables
         DD_RU        'maximum up-reserve demand'
         DD_RD        'maximum down-reserve demand'
              ;
*Dual variables
Free variables
         lambda_RU    'up-reserve price'
         lambda_RD    'down-reserve price'
...
*Primary feasibility
*reserve
         URB           'up-reserve balance'
         DRB           'down-reserve balance'
