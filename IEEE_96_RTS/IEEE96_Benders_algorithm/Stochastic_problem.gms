...
Loop(alpha,
         P_a(k,t,s)=P_b(s,t)*wind_cap(k)*0.15;

         Solve StochD using lp minimizing cost;

         Total_expected_costs_for_diff_alpha(alpha)=cost.l;
);
Display Total_expected_costs_for_diff_alpha;
